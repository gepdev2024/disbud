    ...
    <section class="container mt-4">
        ...
        <form action="laporTemuan" method="POST" enctype="multipart/form-data" id="myForm">
                        ...
                        <div class="row gy-3 gx-4 mb-3 ">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" aria-label="Default select example"
                                        id="satuanWaktuPembuatan" name="kepemilikan_provinsi">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" aria-label="Default select example"
                                        id="satuanWaktuPembuatan" name="kepemilikan_kota">
                                        <option selected value="">Pilih</option>
                                        <option value="tes">tes</option>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" aria-label="Default select example"
                                        id="satuanWaktuPembuatan" name="kepemilikan_kecamatan">
                                        <option selected value="">Pilih</option>
                                        <option value="tes">tes</option>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" aria-label="Default select example"
                                        id="satuanWaktuPembuatan" name="kepemilikan_kelurahan">
                                        <option selected value="">Pilih</option>
                                        <option value="tes">tes</option>
                                    </select>
                                </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                <div class="card text-center">
                                    ...
                                    <div class="card-body position-relative d-inline-block">
                                        ...
                                        <input type="file" id="foto" class="custom-file-input d-none"
                                            name="foto">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card text-center">
                                    ...
                                    <div class="card-body position-relative d-inline-block">
                                        <label for="dokumen_kajian" class="file-label">+ Tambah Dokumen Kajian
                                            (.pdf)</label>
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="card text-center">
                                    ...
                                    <div class="card-body position-relative d-inline-block">
                                        <label for="dokumen_lainnya" class="file-label">+ Tambah Dokumen Lainnya
                                            (.pdf)</label>
            ...
            <div class="col-md-2 mt-4 mx-auto">
                <button type="submit" class="btn btn-primary d-block mx-auto w-100 py-3 fw-bold">Kirim</button>
            </div>
