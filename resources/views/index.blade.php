...
<main id="main">
    ...
    <section id="services" class="services">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                <div class="col-lg-4 mt-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                ...
                <div class="col-lg-4 mt-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box w-100">
                        <div class="icon"><img width="40" src={{asset("assets/img/indragiri_hilir.jpg")}} alt=""></div>
                        <h4><a href="objekWisata/472">Indarhiri Hilir</a></h4>
                        {{-- <p>Voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi</p> --}}
                    </div>
                </div>
                <div class="col-lg-4 mt-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box w-100">
                        <div class="icon"><img width="40" src={{asset("assets/img/indragiri_hulu.png")}} alt=""></div>
                ...
                <div class="col-lg-4 mt-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box w-100">
                        <div class="icon"><img width="40" src={{asset("assets/img/kuantan_singingi.png")}} alt=""></div>
