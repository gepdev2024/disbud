            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        <h4>Useful Links</h4>
                        <ul>
                            <li><i class="bx bx-chevron-right"></i> <a href="#">{{__('landing.beranda')}}</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="#about">{{__('landing.profil')}}</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="#KabupatenKota">{{__('landing.kabkot1')}}</a></li>
                        </ul>   
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        ...
                        <div class="social-links mt-3">
                            <a href="https://m.facebook.com/p/Dinas-Kebudayaan-Provinsi-Riau-100069055995152/?locale=id_ID" target="_blank" class="facebook"><i class="bx bxl-facebook"></i></a>
                            <a href="https://www.instagram.com/disbud.provriau/" target="_blank" class="instagram"><i class="bx bxl-instagram"></i></a>
                        </div>
                    </div>
