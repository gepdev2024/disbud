                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a class="text-primary" href="" data-bs-toggle="modal"
                                                        ...
                                                        data-bs-levelSk="{{ $item->level_sk }}"
                                                        data-bs-tglSk="{{ $item->tgl_sk }}"
                                                        data-bs-description="{{ $item->description }}"
                                                        data-bs-kategori="{{ $item->idS }}"
                                                        data-bs-lokasi="{{ $item->idK }}"
                                                        data-bs-latitude="{{ $item->latitude }}"
                                                        data-bs-longitude="{{ $item->longitude }}"
                                                        data-bs-link="{{ $item->link_360 }}"><i
                                                            class="bx bx-edit-alt me-2"></i>
                                                    </a>
                                                    <a class="text-danger"
                                                        onclick="return confirm('Apakah anda yakin ingin menghapus data?')"
                                                        href="objek-wisata/{{ $item->id }}/delete"><i
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row sk">
                            <div class="col mb-3">
                                ...
                                <input type="date" name="tgl_sk" id="sktgl" class="form-control"
                        ...
                        <div class="row sk">
                            <div class="col mb-3">
                                ...
                                <input type="text" name="no_sk" id="skno" class="form-control"
                                    placeholder="Nomor SK">
                            </div>
                        </div>
                        <div class="row">
