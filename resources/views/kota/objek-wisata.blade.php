...
@section('content')
                      ...
                      <td>
                        <div class="d-flex">
                          <a class="text-primary" href="" data-bs-toggle="modal" data-bs-target="#editForm"
                            ...
                            data-bs-deskripsi="{{ $item->deskripsi }}" data-bs-noSk="{{ $item->no_sk }}"
                            data-bs-status="{{ $item->status }}" data-bs-levelSk="{{ $item->level_sk }}"
                            data-bs-tglSk="{{ $item->tgl_sk }}" data-bs-description="{{ $item->description }}"
                          ...
                          <a class="text-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data?')"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel1">Tambah Objek Cagar Budaya</h5>
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col mb-3">
                ...
                <input required type="text" name="nama" id="nameBasic" class="form-control" placeholder="Nama">
              </div>
            </div>
            <div class="row">
              <div class="col mb-3">
                <label for="emailBasic" class="form-label">Deskripsi</label>
                <textarea name="deskripsi" required type="text" id="emailBasic" class="form-control summernote"
            ...
            <div class="row">
              <div class="col mb-3">
                ...
                <textarea name="description" required type="text" id="emailBasic" class="form-control summernote"
            ...
            <div class="row g-2">
              ...
              <div class="col mb-3">
                ...
                <input onchange="setMarker()" name="longitude" type="text" id="longitude" class="form-control"
  ...
  <div class="modal fade" id="editForm" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel1">Edit Objek Cagar Budaya Benda</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col mb-3">
                ...
                <textarea name="deskripsi" required type="text" id="deskripsi" class="form-control" placeholder="Deskripsi"></textarea>
              </div>
            </div>
            <div class="row">
              <div class="col mb-3">
            ...
            <div class="row g-2">
              <div class="col mb-3">
                ...
                <input onchange="setMarkerEdit()" name="latitude" type="text" id="latitude" class="form-control"
                  placeholder="Latitude">
              </div>
              <div class="col mb-3">
                <label for="longitude" class="form-label">Longitude</label>
                <input onchange="setMarkerEdit()" name="longitude" type="text" id="longitude" class="form-control"
                  placeholder="Longitude">
              </div>
